...
CREATE TABLE ExemploStatus (
	Id UNIQUEIDENTIFIER PRIMARY KEY NOT NULL,
	Descricao VARCHAR(255) NOT NULL
)
GO

INSERT INTO ExemploStatus (Id, Descricao) VALUES (NEWID(), 'Status 1')
INSERT INTO ExemploStatus (Id, Descricao) VALUES (NEWID(), 'Status 2')
INSERT INTO ExemploStatus (Id, Descricao) VALUES (NEWID(), 'Status 3')